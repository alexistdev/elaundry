...
import com.coder.elaundry_apps.model.HistoryViewModel;
...
public class LaundryUser extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        HistoryViewModel history = new ViewModelProvider(this).get(HistoryViewModel.class);
        SharedPreferences sharedPreferences = requireContext().getSharedPreferences(
                Constants.KEY_USER, Context.MODE_PRIVATE);
        String idUser = sharedPreferences.getString("idUser", "");
        history.getUiState().observe(this, uiState -> setData(getContext(),idUser));
    }
